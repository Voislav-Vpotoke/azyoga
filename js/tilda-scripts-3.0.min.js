...
function t_outerWidth(t) {
	...
	return (
		...
		'auto' === o && (o = 0),
		'auto' === i && (i = 0),
		parseInt(n) + parseInt(o) + parseInt(i)
	)
}
var version
...
;(window.isSearchBot = !1),
	...
	t_onReady(function () {
		...
		if (-1 !== t.indexOf('Android') && (n || e || o || i || a)) {
			...
			var l = 100 / r.getBoundingClientRect().height
	...
	t_onReady(function () {
		...
		if (
			...
			var i = Array.prototype.slice.call(e).filter(function (t) {
				return (
			...
			for (n = 0; n < i.length; n++) {
				...
				t_addClass(a, r > 1e3 && r > l ? 'r_hidden' : 'r_showed'),
					t_addClass(a, 'r_anim')
			}
			if (i.length) {
				function d() {
		...
		function e() {
			...
			for (var a = 0; a < i.length; a++) {
				...
				;(n = getComputedStyle(r).display),
					(t = r.getAttribute('data-screen-max')) || (t = 1e4),
					(e = r.getAttribute('data-screen-min')) || (e = 0),
					(t = parseInt(t)),
					(e = parseInt(e)) <= t &&
						(o <= t && o > e
	...
	(function () {
		...
		function e() {
			for (
				...
				if ((p = (m = t[n]).style).height.indexOf('vh') > -1) {
					e = parseInt(p.height, 10) / 100
					var o = document.createElement('div')
					;(o.id = 'tempDiv'),
						(o.style.cssText =
							'position:absolute;top:0;left:0;width:100%;height:100vh;visibility:hidden;'),
						document.body.appendChild(o)
					var i = document.getElementById('tempDiv'),
						a = parseInt(getComputedStyle(i).height.replace('px', ''))
					t_removeEl(i)
					var r = Math.round(a * e) + 'px',
						l = m.closest('.t-cover')
					if (l) {
						var d = l.querySelector('.t-cover__filter'),
							s = l.querySelector('.t-cover__wrapper')
						l.style.height = r
					}
					d && (d.style.height = r), s && (s.style.height = r), (p.height = r)
				}
			}
			var c = document.querySelectorAll('[data-height-correct-vh]'),
				u = window.innerHeight
			e = 0
			for (n = 0; n < c.length; n++) {
				var m, p
				;(p = (m = c[n]).style).height.indexOf('vh') > -1 &&
					((e = parseInt(p.height) / 100), (r = u + 'px'), (p.height = r))
			}
		}
		function n() {
		...
		function o(t) {
			for (
				...
				if (i) {
					var a,
						r = 'rem' === o.getAttribute('data-auto-correct-font-size')
