...
!(function (t, e, i, n) {
	...
	function X(t, e) {
		...
		for (r = 0; r < o.length; )
			n[o[r].identifier] && a.push(o[r]),
				e & (It | At) && delete n[o[r].identifier],
				r++
	...
	function tt(t, e) {
		;(this.options = nt({}, Q.defaults, e || {})),
			...
			(this.input = (function (t) {
				...
				return new (e || (dt ? R : vt ? N : ft ? Y : O))(t, _)
			})(this)),
	...
	h(M, A, {
		handler: function (t) {
			...
			if ((e === yt && (this.started = !0), this.started)) {
				...
				e & (It | At) && i[0].length - i[1].length == 0 && (this.started = !1),
					this.callback(this.manager, e, {
						pointers: i[0],
						changedPointers: i[1],
						pointerType: mt,
	...
	;(H.prototype = {
		...
		requireFailure: function (t) {
			...
			return (
				-1 === g(e, (t = V(t, this))) && (e.push(t), t.requireFailure(this)),
				this
			)
		},
		...
		emit: function (t) {
			...
			var i = this,
				n = this.state
			se > n && e(i.options.event + L(n)),
				e(i.options.event),
				t.additionalEvent && e(t.additionalEvent),
				n >= se && e(i.options.event + L(n))
		},
		tryEmit: function (t) {
		...
		recognize: function (t) {
			...
			return c(this.options.enable, [this, e])
				? (this.state & (oe | ae | he) && (this.state = ie),
				  (this.state = this.process(e)),
				  void (this.state & (ne | re | se | ae) && this.tryEmit(e)))
		...
		h(B, H, {
			...
			process: function (t) {
				...
				if (((this._input = t), !n || !i || (t.eventType & (It | At) && !s)))
					this.reset()
				...
				for (var s = 0; s < n.length; )
					(i = n[s]),
						2 === e.stopped || (r && i != r && !i.canRecognizeWith(r))
							? i.reset()
							: i.recognize(t),
						!r && i.state & (ne | re | se) && (r = e.curRecognizer = i),
						s++
			}
		},
		get: function (t) {
